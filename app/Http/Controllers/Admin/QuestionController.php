...
class QuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.allQuestion.index',compact('m_questions'));
    }
    ...
    public function create()
    {
        ...
        $marks = Mark::all();
        $times = Time::all();
        return view('admin.allQuestion.create', compact('subjects','semesters','terms','sections','marks','times'));
...
//        $id=$data->save();
    ...
    public function show($id)
    {
        ...
        return view('admin.allQuestion.show',compact('question'));
    }
