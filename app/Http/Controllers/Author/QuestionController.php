...
class QuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('author.allQuestion.index',compact('m_questions'));
    }

    public function public()
    {
        $m_questions = Auth::user()->mainquestions()->latest()->published()->get();
        return view('author.allQuestion.publics',compact('m_questions'));
    }
    ...
    public function create()
    {
        ...
        $marks = Mark::all();
        $times = Time::all();
        return view('author.allQuestion.create', compact('subjects','semesters','terms','sections','marks','times'));
...
//        $id=$data->save();
    ...
    public function show($id)
    {
        ...
        return view('author.allQuestion.show',compact('question'));
    }
    ...
    public function edit($id)
    {
       $question = Mainquestion::find($id);
        ...
        return view('author.allQuestion.edit',compact('question','subjects','semesters','terms','sections','marks','times'));
    }
